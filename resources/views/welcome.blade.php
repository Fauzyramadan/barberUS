...
<body class="antialiased">
        ...
        <div class="container mx-auto px-4 ">
            <div class="flex items-center justify-between py-4">
                ...
                <div class="hidden sm:flex sm:items-center">
                    ...
                    <a href="#about" class="text-gray-300 text-sm font-semibold hover:text-white mr-4">About</a>
                    <a href="#service" class="text-gray-300 text-sm font-semibold hover:text-white mr-4">Service</a>
                    <a href="#bottom" class="text-gray-300 text-sm font-semibold hover:text-white">Contact</a>
                </div>
    ...
    <div class="bg-slate-700 text-white py-20" id="top">
        <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-16">
            <div class="flex flex-col w-full justify-center items-center p-16">
                ...
                <p class="text-sm md:text-base text-gray-50 mb-4 ">Ekspresikan kegantengan lo dan jadilah bagian dari pria percaya diri 100%</p>
    ...
    <!-- === about ===  -->
    <div class="sm:flex items-center max-w-screen-xl" id="about">
    ...
    <!-- === SERVICE ===  -->
    <div class="flex flex-col mt-px w-full justify-center items-center" id="service">
        <h1 class="text-3xl md:text-5xl text-slate-700 text-center tracking-loose font-bold">Semua service bikin lo <span class="bg-slate-700 px-2 mt-4 text-slate-200 italic">tampil beda !</span></h1>
        <service class="flex my-px items-start max-w-screen-xl">
            ...
            <div class=" m-10 bg-yellow-400 rounded-lg shadow-xl cursor-pointer hover:bg-gradient-to-br from-yellow-300 to-yellow-600 hover:shadow-slate-400 hover:shadow-lg">
        ...
        <a class="items-start flex text-4xl font-extrabold mb-12 px-5 py-2 text-center rounded-full bg-slate-600 text-slate-200 shadow-xl hover:bg-gradient-to-br from-slate-400 to-slate-700 hover:shadow-slate-700 hover:shadow-lg" href="#">Booking <span class="text-lg italic font-semibold ml-1">for now</span></a>
    </div>
    <!--===FOOTER===-->
